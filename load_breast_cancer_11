...
#데이터의 설명이 담겨있는 변수를 출력
print(bc.DESCR)

#feature에 대한 설명이 담긴 변수를 출력
...
# trainig dataset과 test dataset을 간단히 분리
...
# sklearn.metrics의 accuaracy_score함수를 import
from sklearn.metrics import accuracy_score

#y_test 와  y_pred를 인자로 넣어 정확도를 구함
